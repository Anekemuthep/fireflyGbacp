...
/* package fireflyGbacp-0.1.0.0 */
#define VERSION_fireflyGbacp "0.1.0.0"
#define MIN_VERSION_fireflyGbacp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "fireflyGbacp-0.1.0.0-J2A8rv1wkZpIP1ofKyg7i"

#define CURRENT_PACKAGE_KEY "fireflyGbacp-0.1.0.0-J2A8rv1wkZpIP1ofKyg7i"
